...
#
# File taken from https://github.com/elixir-plug/plug/blob/v1.11.0/lib/plug/html.ex and
# modified with a different module name.
defmodule ContentfulRenderer.HtmlEscape do
  @moduledoc """
